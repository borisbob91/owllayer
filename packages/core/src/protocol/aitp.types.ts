...
/**
 * Types de messages du protocole AITP.
...
// ============================================================
// Message AITP (enveloppe)
// ============================================================

export interface AITPMessageMeta {
  sessionId?: string;
  token?: string;
}

/**
 * Union discriminee de tous les types de messages AITP.
 */
export type AITPMessage =
  | {
      id: string;
      type: MessageType.HANDSHAKE_INIT;
      timestamp: number;
      payload: HandshakeInitPayload;
      meta?: AITPMessageMeta;
    }
  | {
      id: string;
