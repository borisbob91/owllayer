...
/** Bouquet de langues couvert par les modeles Nova-3/Nova-2 multilingues et par flux-general-multi. */
const MULTILINGUAL_BUNDLE = ['en', 'es', 'fr', 'de', 'hi', 'ru', 'pt', 'ja', 'it', 'nl'] as const;

/** Langues supportees par les modeles Nova-3/Nova-3-general (liste documentee, cf. DG-1 pour re-verification). */
