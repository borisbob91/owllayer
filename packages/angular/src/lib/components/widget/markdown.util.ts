/**
 * Utilitaire de formatage Markdown sécurisé pour les bulles de chat OwlLayer.
 * Échappe le HTML brut puis convertit le markdown (gras, italique, code, listes, liens).
 */
