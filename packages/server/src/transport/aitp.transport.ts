...
const log = createLogger('OwlLayer:Transport');
...
/**
 * WebSocketTransport - Gere les connexions WebSocket AITP.
 *
 * Responsabilites :
 * - Accepter les connexions
 * - Encoder/decoder les messages AITP
 * - Heartbeat (ping/pong)
 * - Envoyer des messages a des connexions specifiques
 */
export class AITPTransport implements Transport {
  ...
  /**
   * Envoyer un message AITP a une connexion.
   */
