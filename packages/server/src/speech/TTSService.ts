// ============================================================
// Base TTS Service
// Classe abstraite pour tous les providers TTS
// ============================================================
...
export abstract class BaseTTSService implements TTSService {
  ...
  protected normalizeText(text: string): string {
    return text
      .replace(/\r\n/g, '\n')
      .replace(/[ \t]+/g, ' ') // Réduire espaces/tabs multiples
      .replace(/[ \t]*\n[ \t]*/g, '\n') // Nettoyer espaces autour des retours ligne
  ...
  protected estimateDuration(text: string, speed: number = 1.0): number {
    ...
    return Math.ceil(minutes * 60 * 1000); // en ms
  }
