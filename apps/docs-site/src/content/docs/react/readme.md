...
OwlLayer est un SDK d'**AI-driven interfaces**, ou interfaces agentiques : l'agent agit dans l'interface existante uniquement par les tools que le développeur déclare. `@owllayer/react` apporte ce contrat aux composants et hooks React, sans changer la nature de votre front.
