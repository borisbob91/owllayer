...
Get OwlLayer AI running locally in minutes, either with the included demo or from scratch.
...
Open `http://localhost:5173`. You'll see **ShopMate**, a mock e-commerce store with an embedded OwlLayer AI chat.
