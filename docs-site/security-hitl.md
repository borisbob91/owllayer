...
Security is a core design principle of OwlLayer AI. Because AI agents dynamically execute tools that manipulate client interfaces or database states, the OwlLayer AI Runtime enforces a strict sandboxed safety model called **Human-in-the-Loop (HITL)**.
...
sequenceDiagram
    ...
    participant Core as OwlLayer AI Runtime
...
When sessions bridge audio streams and tool executions, OwlLayer AI compiles a lightweight authorization token called a **LineToken**.
