# Introduction to OwlLayer AI

OwlLayer AI is an open-source **Agentic UI SDK** designed to give AI models direct, secure, and real-time control over web applications.

Unlike generic chatbots or UI generation tools, OwlLayer AI connects an AI agent directly to the active elements of your existing application. The agent sees what the user sees, reasons about the context, and invokes actions (tools) declared natively by your front-end components.
...
| **Agentic UI (OwlLayer AI)** | Connecting the AI directly to your **existing** components and actions. | None. You keep your styles, business logic, and security rules. |

With OwlLayer AI, your application remains the owner of its business logic. The AI is simply a new way to pilot the existing interface.
...
OwlLayer AI acts as a bridge between the Browser and the Server via **AITP** (Agent-to-Interface Transfer Protocol), formerly known as **ADTP**:
