# Issue GitHub #14 : Migration de DomOS vers OwlLayer AI

**Issue GitHub** : https://github.com/borisbob91/domos/issues/14
**Statut** : Planifié
**Priorité** : Majeure
...
- [ ] [#15 — Nomenclature OwlLayer AI et guide AITP](https://github.com/borisbob91/domos/issues/15)

### Fondations

- [ ] [#16 — Core et compatibilité AITP](https://github.com/borisbob91/domos/issues/16)
- [ ] [#30 — Consolidation audio dans Core Media](https://github.com/borisbob91/domos/issues/30)

### Runtime partagé et navigateur

- [ ] [#18 — UI Runtime](https://github.com/borisbob91/domos/issues/18)
- [ ] [#19 — Browser SDK](https://github.com/borisbob91/domos/issues/19)

### Adapters modèles, voix et realtime

- [ ] [#20 — OpenAI](https://github.com/borisbob91/domos/issues/20)
- [ ] [#21 — Google](https://github.com/borisbob91/domos/issues/21)
- [ ] [#22 — Anthropic](https://github.com/borisbob91/domos/issues/22)
- [ ] [#23 — LiveKit](https://github.com/borisbob91/domos/issues/23)

### SDK frameworks et serveur

- [ ] [#24 — React](https://github.com/borisbob91/domos/issues/24)
- [ ] [#25 — Vue](https://github.com/borisbob91/domos/issues/25)
- [ ] [#26 — Svelte](https://github.com/borisbob91/domos/issues/26)
- [ ] [#27 — Angular](https://github.com/borisbob91/domos/issues/27)
- [ ] [#28 — Server Runtime](https://github.com/borisbob91/domos/issues/28)

## Matrice des packages publics

| Package actuel | Package OwlLayer AI | Issue |
|---|---|---:|
| `@domos/core` | `@owllayer/core` | #16 |
| `@domos/ui` | `@owllayer/ui` | #18 |
| `@domos/browser` | `@owllayer/browser` | #19 |
| `@domos/adapter-openai` | `@owllayer/adapter-openai` | #20 |
| `@domos/adapter-google` | `@owllayer/adapter-google` | #21 |
| `@domos/adapter-anthropic` | `@owllayer/adapter-anthropic` | #22 |
| `@domos/adapter-livekit` | `@owllayer/adapter-livekit` | #23 |
| `@domos/react` | `@owllayer/react` | #24 |
| `@domos/vue` | `@owllayer/vue` | #25 |
| `@domos/svelte` | `@owllayer/svelte` | #26 |
| `@domos/angular` | `@owllayer/angular` | #27 |
| `@domos/server` | `@owllayer/server` | #28 |

`@domos/audio` n'est pas renommé ni publié sous le scope OwlLayer AI. Ses
...
- Retirer immédiatement tous les alias DomOS ou ADTP.
